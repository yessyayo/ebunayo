...
const Header = () => {
  ...
  return (
    <header className="w-full p-3 fixed top-0 left-0 bg-[#F6FFF5] z-50 shadow">
      {/* logo and hamburger */}
      ...
      {/* Dropdown Menu */}
      {isMenuOpen && (
        <nav className="absolute top-[110px] right-0 w-[393px] h-[89vh] bg-[#F6FFF5] shadow p-[20px] text-gray-700 font-medium">
          ...
          <ul className="w-[228px] flex flex-col gap-[32px]">
            <li>
              <a
                href="#Home"
                onClick={toggleMenu}
                className="block px-[10px] py-[6px] hover:text-green-600 transition"
              >
                Home
              </a>
            </li>
